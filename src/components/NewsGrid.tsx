...
const news = [
  ...
  },
  {
    ...
    categoryColor: "text-violet-400 bg-violet-400/10 border-violet-400/20",
    dot: "bg-violet-400",
    title: "Google DeepMind создала ИИ, предсказывающий структуру белков с точностью 99%",
    excerpt: "AlphaFold 3 теперь способен предсказывать взаимодействие белков с ДНК и РНК, что открывает новые горизонты в разработке лекарств против рака и болезни Альцгеймера.",
    date: "18 апреля 2026",
    readTime: "5 мин",
  },
  {
    ...
    categoryColor: "text-cyan-400 bg-cyan-400/10 border-cyan-400/20",
    dot: "bg-cyan-400",
    title: "Tesla Optimus начал работать на конвейере наравне с людьми",
    excerpt: "На заводе в Техасе 50 роботов Optimus Gen 3 выполняют задачи сборки электромоторов. Илон Маск анонсировал выпуск миллиона роботов к концу 2027 года.",
    date: "18 апреля 2026",
    readTime: "4 мин",
  },
  {
    ...
    categoryColor: "text-amber-400 bg-amber-400/10 border-amber-400/20",
    dot: "bg-amber-400",
    title: "NASA подтвердило дату первой пилотируемой миссии на Марс",
    excerpt: "Запуск корабля Orion с экипажем из шести человек запланирован на ноябрь 2028 года. Полёт займёт около семи месяцев.",
    date: "17 апреля 2026",
    readTime: "6 мин",
  },
  {
    ...
    categoryColor: "text-violet-400 bg-violet-400/10 border-violet-400/20",
    dot: "bg-violet-400",
    title: "Китайские учёные обучили ИИ читать мысли по активности мозга",
    excerpt: "Система BrainGPT с точностью 87% декодирует внутреннюю речь человека по данным ЭЭГ-шлема. Эксперты обсуждают как медицинский потенциал, так и угрозу приватности.",
    date: "17 апреля 2026",
    readTime: "6 мин",
  },
  {
    ...
    categoryColor: "text-cyan-400 bg-cyan-400/10 border-cyan-400/20",
    dot: "bg-cyan-400",
    title: "Дроны-курьеры Wing начали доставку в 20 новых городах Европы",
    excerpt: "Дочерняя компания Alphabet расширила сеть автономной доставки. Дрон доставляет посылку до 2 кг в радиусе 10 км за 15 минут без участия оператора.",
    date: "16 апреля 2026",
    readTime: "3 мин",
  },
  {
    ...
    categoryColor: "text-amber-400 bg-amber-400/10 border-amber-400/20",
    dot: "bg-amber-400",
    title: "Китайская станция на Луне передала первые образцы грунта с обратной стороны",
    excerpt: "Миссия Chang'e 7 доставила 1,2 кг лунного реголита из кратера Шеклтон — исследователи ожидают найти следы водяного льда.",
    date: "15 апреля 2026",
    readTime: "5 мин",
  },
]
